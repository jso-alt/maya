...
//Name: checker.ma
//Last modified: Wed, Jan 28, 2026 11:41:17 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "1539B037-44EB-44FB-4755-3F9A964C7278";
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
	setAttr ".ai_translator" -type "string" "orthographic";
createNode phong -n "checker";
	rename -uid "7CA16563-489D-63B7-BC46-D3813EA589F3";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2BE7D104-48C1-D0D4-DBF3-E2BEAD06209B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F1463E30-4D22-0791-E702-2386752EA0C5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D7CBC155-4666-89CA-F138-9D83E1E3E355";
createNode displayLayerManager -n "layerManager";
	rename -uid "78D31AF4-496E-9671-2966-169B727149D7";
createNode displayLayer -n "defaultLayer";
	rename -uid "19FADF5C-43F8-1F99-8CE3-0A8853DA934F";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B4EC72B2-4A91-B663-356B-22A9D10397CF";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "C896251C-453F-C968-9A6C-4F8D6245EDB2";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -382.1428419578649 -313.09522565395167 ;
	setAttr ".tgi[0].vh" -type "double2" 382.1428419578649 311.90474951078073 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "bulge1.oc" "checker.ambc";
...
connectAttr "checker.oc" ":internal_standInSE.ss";
// End of checker.ma
