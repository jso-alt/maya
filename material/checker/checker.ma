...
//Name: checker.ma
//Last modified: Tue, Feb 03, 2026 03:35:04 PM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "30EFA5D0-47DB-B6B7-B21C-2BAE0188710D";
fileInfo "vrayBuild" "5.20.02 2341490";
createNode transform -s -n "persp";
	rename -uid "26917220-44CC-7648-2BE7-1185EEC9CD0C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 28 21 28 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -5.172681101354183e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4DDBA252-4DC5-E6FE-5235-408D3F8B83AE";
	setAttr -k off ".v" no;
...
createNode transform -s -n "top";
	rename -uid "BBDCBD8B-407E-9822-D74E-C9B0F92D1C99";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "D7B81E52-4FDB-3019-9CE4-40A89FC696E7";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "C83F3D01-4D9F-EB47-4CD0-069D1409F1AB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "2F938B4F-4D35-49B7-2C4F-1E833EE25027";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "223B8616-4EF8-7F13-F146-3FB0F70C7632";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "7C38B88E-4AE6-2542-C505-93BB8F17ED76";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "pSphere1";
	rename -uid "0D40DB0B-4AE8-C4B4-C765-E7AF5189A67E";
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "BD43F1E2-408B-52D5-48C9-F493147ACEFF";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pCube1";
	rename -uid "AD1FA586-421C-070F-10ED-BC9992B6B3AF";
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "5098D471-4427-821C-548A-DAACF94E08A5";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode bulge -n "bulge1";
	rename -uid "F004AA45-4C6B-0C7B-8FCC-0E872F9E6CE5";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "33B0C81C-45B8-9525-92CF-EFA634E4F511";
	setAttr ".re" -type "float2" 4 4 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "36E9A18D-46C1-4275-6548-5A9A544411C6";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode RedshiftOptions -s -n "redshiftOptions";
	rename -uid "152A4E44-4945-0473-64D6-C79CE68FB839";
	setAttr ".version" 5;
...
createNode RedshiftPostEffects -n "defaultRedshiftPostEffects";
	rename -uid "7881A1A7-43B3-50E9-1309-6F81F911DF7E";
	setAttr ".v" 2;
...
createNode VRaySettingsNode -s -n "vraySettings";
	rename -uid "96C2F7D7-413A-C181-5A2F-29908E5768A9";
	setAttr ".gi" yes;
	setAttr ".rfc" yes;
	setAttr ".pe" 2;
	setAttr ".se" 3;
	...
	setAttr ".jpegq" 100;
	setAttr ".vfbOn" yes;
	setAttr ".vfbSA" -type "Int32Array" 1048 0 4183 1 4171 0 1
		 4163 1700143739 1869181810 825893486 1632379436 1936876921 578501154 1936876886 577662825 573321530 1935764579 574235251
		 ...
		 1818589289 1886609759 1601463141 975335023 1936482662 1881287781 1818589289 1718511967 1869373295 1684368227 1634089506 744846188
		 2020175906 1767861349 1601136238 1920102243 1702126437 1868783460 1936879468 1634089506 2103800684 1665212972 1852795252 2067407475
		 1919252002 1852795251 741423650 1969319970 1346987379 1751342930 1701536613 1715085924 1702063201 1702109740 1699902579 1634885491
		 577726820 741422394 1936028706 1936020084 1701339999 1684368227 1634089506 744846188 1650811938 1750296437 1852400737 1634885479
		 577726820 741750074 1650811938 1750296437 1852400737 1751342951 1701536613 1715085924 1702063201 1953702444 1868919397 1701080909
		 1684107871 975335273 573323319 1919251571 1867345765 1667196260 1801676136 975332453 1936482662 8224101 ;
	setAttr ".vfbSyncM" yes;
	setAttr ".mSceneName" -type "string" "D:/Maya/libby/material/checker/checker.ma";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F38C0B4F-4FA7-75E6-76AB-ADBE1A22A5F3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "34BFE81E-4831-3F47-144C-718D9A9C52AB";
createNode displayLayerManager -n "layerManager";
	rename -uid "C414B9A6-4F87-7476-7DFB-66B866A7346A";
createNode displayLayer -n "defaultLayer";
	rename -uid "19FADF5C-43F8-1F99-8CE3-0A8853DA934F";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6507FBF4-4ECB-61E2-B637-50A5F8BE3A85";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "888648E5-4BD0-5B40-A979-24821900B796";
	setAttr ".g" yes;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "F6BDD3E0-483D-F804-F106-F7A597C19A52";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "7A266FC9-42BD-A95A-32C4-9FB0A4E6C2DB";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode polySphere -n "polySphere1";
	rename -uid "57F38694-4FA8-9606-E9C0-7483F75DC7EA";
createNode polyCube -n "polyCube1";
	rename -uid "05E1793D-4119-1B53-0C04-0B80CBC0EBFF";
	setAttr ".cuv" 4;
createNode lambert -n "checker";
	rename -uid "FA61FBA5-483F-5D8B-00C5-DD9EDD9AC7BC";
	setAttr ".ic" -type "float3" 0 1 1 ;
createNode shadingEngine -n "chckerSG";
	rename -uid "9771EFE0-492D-408B-8BD8-88A160552A8F";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "34A47B83-4D1A-4664-2CF4-13BB3CA113EB";
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "B3EDF733-4DAC-EDA5-CAF8-0ABC3FA1279C";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -282.71382635644824 24.307598036031095 ;
	setAttr ".tgi[0].vh" -type "double2" 531.90957025522334 431.05121865943198 ;
	setAttr -s 5 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 233.14039611816406;
	setAttr ".tgi[0].ni[0].y" 374.54461669921875;
	setAttr ".tgi[0].ni[0].nvs" 1923;
	setAttr ".tgi[0].ni[1].x" -61.504753112792969;
	setAttr ".tgi[0].ni[1].y" 388.17849731445312;
...
relationship "link" ":lightLinker1" "chckerSG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "chckerSG.message" ":defaultLightSet.message";
connectAttr "defaultRedshiftPostEffects.msg" ":redshiftOptions.postEffects";
connectAttr "layerManager.dli[0]" "defaultLayer.id";
connectAttr "renderLayerManager.rlmi[0]" "defaultRenderLayer.rlid";
connectAttr "bulge1.oc" "checker.c";
connectAttr "checker.oc" "chckerSG.ss";
connectAttr "pSphereShape1.iog" "chckerSG.dsm" -na;
connectAttr "chckerSG.msg" "materialInfo1.sg";
connectAttr "checker.msg" "materialInfo1.m";
connectAttr "bulge1.msg" "materialInfo1.t" -na;
connectAttr "chckerSG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "checker.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
...
connectAttr ":initialShadingGroup.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "chckerSG.pa" ":renderPartition.st" -na;
